...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <section class="page-section projects" id="projects">
            ...
            <button class="btn btn-success float-right newItem" onclick="addNewProject()"><i class="fa fa-plus"></i>Add new project</button>
            <table class="table">
                <thead>
                    <tr>
                        <th scope="col">#</th>
        ...
        <div class="portfolio-modal modal fade" id="createEditProject" tabindex="-1" role="dialog" aria-labelledby="portfolioModal1Label" aria-hidden="true">
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <div class="form-group">
                                        <button onclick="closeModal('createEditProject')" class="btn btn-danger">Cancel</button>
